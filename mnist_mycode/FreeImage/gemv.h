...
//void sgemm(cublasHandle_t cublasHandle, int i, int m, int n, float alpha,
//	const float *A, const float *x,
//	float beta, float *y)
//{
//	//checkCublasErrors(cublasSgemmEx(cublasHandle, CUBLAS_OP_N, CUBLAS_OP_N, i, m, n, &alpha, A, CUDA_R_16F, i, x, CUDA_R_16F, n, &beta, y, CUDA_R_16F, i));
//
//	checkCublasErrors(cublasSgemm(cublasHandle, CUBLAS_OP_N, CUBLAS_OP_N, i, m, n, &alpha, A, m, x, n, &beta, y, n));
//};
